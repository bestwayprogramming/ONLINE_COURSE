...
$ret=mysqli_query($con,"update semester set semester='$semester',updationDate='$currentTime' where id='$id'");
if($ret)
{
...
<?php
$sql=mysqli_query($con,"select * from semester where id='$id'");
$cnt=1;
...
?>
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" id="semester" name="semester" placeholder="semester" value="<?php echo htmlentities($row['semester']);?>" required />
  </div> 
